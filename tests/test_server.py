...
@pytest.mark.asyncio
class TestServer:
    async def test_start_server(self, echo_server, free_bind, echo_tester):
        addr = free_bind()
    ...
    async def test_start_lpf_server(self, echo_server, free_bind, echo_tester):
        addr = free_bind()
    ...
    async def test_start_rpf_server(self, echo_server, free_bind, echo_tester):
        addr = free_bind()
